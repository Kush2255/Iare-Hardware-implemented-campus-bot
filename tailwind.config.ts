  	...
  	extend: {
		...
		keyframes: {
			...
			'scroll-reverse': {
				...
				'25%': { transform: 'translateX(10px) translateY(5px) scale(1.05)' },
				'50%': { transform: 'translateX(-10px) translateY(-5px) scale(1)' },
				'75%': { transform: 'translateX(5px) translateY(10px) scale(1.05)' },
		...
		animation: {
			...
			'scroll-slow': 'scroll-slow 20s ease-in-out infinite',
			'scroll-reverse': 'scroll-reverse 25s ease-in-out infinite',
			'scrollHorizontal': 'scrollHorizontal 30s linear infinite',
			'scrollVertical': 'scrollVertical 25s linear infinite',
			'slideshow': 'slideshow 32s ease-in-out infinite'
		},
  		boxShadow: {
  			'2xs': 'var(--shadow-2xs)',
  			xs: 'var(--shadow-xs)',
